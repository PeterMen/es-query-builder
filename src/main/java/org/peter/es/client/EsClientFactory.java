...
//
//        //如果本地未缓存，则加载
//        String serverCluster = properties.getProperty(esTag + ES_HOSTS);
//        if(StringUtils.isEmpty(serverCluster)){
//            throw  new IllegalStateException(esTag+"地址未配置");
//        }
//        RestClientBuilder builder = RestClient.builder(HttpHost.create(serverCluster));
//
//        if(uniqueConnectTimeConfig){
//            setConnectTimeOutConfig(builder);
//        }
//        if(uniqueConnectNumConfig){
//            setMutiConnectConfig(builder, esTag);
//        }
...
//            requestConfigBuilder.setConnectTimeout(Integer.parseInt(properties.getProperty(CONNECT_TIME_OUT)));
//            requestConfigBuilder.setSocketTimeout(Integer.parseInt(properties.getProperty(SOCKET_TIME_OUT)));
//            requestConfigBuilder.setConnectionRequestTimeout(Integer.parseInt(properties.getProperty(CONNECTION_REQUEST_TIME_OUT)));
...
//     */
//    public void setMutiConnectConfig(RestClientBuilder builder, String esTag){
//        builder.setHttpClientConfigCallback(httpClientBuilder -> {
//            httpClientBuilder.setMaxConnTotal(Integer.parseInt(properties.getProperty(MAX_CONNECT_NUM)));
//            httpClientBuilder.setMaxConnPerRoute(Integer.parseInt(properties.getProperty(MAX_CONNECT_PER_ROUTE)));
//            AWSCredentialsProvider credentialsProvider = new EC2ContainerCredentialsProviderWrapper();
//            AWSSigner awsSigner = new AWSSigner(credentialsProvider, properties.getProperty(esTag+".amazon.region"), "es", () -> now(UTC));
...
//        String esTag = properties.getESName(serviceTag);
//        if(StringUtils.isEmpty(esTag)){
//            throw new IllegalStateException(serviceTag+"_es集群地址未配置。");
//        }
